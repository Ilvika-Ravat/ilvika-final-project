...
This model shows that the gender gap is fairly consistent across URM groups. The interaction term is weak, which suggests that the relationship between gender and exam performance does not change dramatically depending on URM status.
...
This model suggests that grading structure may influence exam performance. Courses using an S-N basis are associated with lower exam percentages overall, but the gender-by-grading interaction is not strong enough to show that grading changes the gender effect in a major way.
